  ...
  outputs = inputs@{
    ...
    in
    {
      ...
      checks = forAllSystems (system:
        ...
        assert evalDownloaders.config.systemd.services.moviepilot-seed-downloaders.environment.MOVIEPILOT_API_BASE_URL == "http://127.0.0.1:3001/api/v1";
        assert lib.hasInfix "moviepilot-backend.service" (builtins.concatStringsSep " " evalDownloaders.config.systemd.services.moviepilot-seed-downloaders.requires);
        assert lib.hasInfix "moviepilot-seed-downloaders.service" (builtins.concatStringsSep " " evalDownloaders.config.systemd.services.moviepilot-frontend.requires);
        ...
        assert lib.hasInfix "moviepilot-backend.service" (builtins.concatStringsSep " " evalPlugins.config.systemd.services.moviepilot-seed-installed-plugins.requires);
        assert lib.hasInfix "moviepilot-seed-installed-plugins.service" (builtins.concatStringsSep " " evalPlugins.config.systemd.services.moviepilot-seed-plugin-configs.requires);
        assert lib.hasInfix "moviepilot-seed-installed-plugins.service" (builtins.concatStringsSep " " evalPlugins.config.systemd.services.moviepilot-seed-plugin-folders.requires);
        assert lib.hasInfix "moviepilot-seed-installed-plugins.service" (builtins.concatStringsSep " " evalPlugins.config.systemd.services.moviepilot-frontend.requires);
        assert lib.hasInfix "moviepilot-seed-plugin-configs.service" (builtins.concatStringsSep " " evalPlugins.config.systemd.services.moviepilot-frontend.requires);
        assert lib.hasInfix "moviepilot-seed-plugin-folders.service" (builtins.concatStringsSep " " evalPlugins.config.systemd.services.moviepilot-frontend.requires);
        assert lib.hasInfix "moviepilot-api-seed.py installed-plugins" evalPlugins.config.systemd.services.moviepilot-seed-installed-plugins.script;
        assert lib.hasInfix "moviepilot-api-seed.py plugin-configs" evalPlugins.config.systemd.services.moviepilot-seed-plugin-configs.script;
        ...
        assert lib.hasInfix "moviepilot-api-seed.py plugin-folders" evalPlugins.config.systemd.services.moviepilot-seed-plugin-folders.script;
